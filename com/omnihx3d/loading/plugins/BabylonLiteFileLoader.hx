package com.omnihx3d.loading.plugins;

import com.omnihx3d.actions.Action;
import com.omnihx3d.actions.ActionManager;
import com.omnihx3d.actions.Condition;
import com.omnihx3d.actions.ValueCondition;
import com.omnihx3d.animations.Animation;
import com.omnihx3d.bones.Bone;
import com.omnihx3d.bones.Skeleton;
import com.omnihx3d.cameras.AnaglyphArcRotateCamera;
import com.omnihx3d.cameras.AnaglyphFreeCamera;
import com.omnihx3d.cameras.ArcRotateCamera;
import com.omnihx3d.cameras.Camera;
import com.omnihx3d.cameras.FollowCamera;
...
import com.omnihx3d.lights.Light;
...
import com.omnihx3d.loading.plugins.BabylonFileLoader;
import com.omnihx3d.materials.FresnelParameters;
import com.omnihx3d.materials.Material;
import com.omnihx3d.materials.MultiMaterial;
import com.omnihx3d.materials.StandardMaterial;
import com.omnihx3d.materials.textures.CubeTexture;
import com.omnihx3d.materials.textures.MirrorTexture;
...
import com.omnihx3d.mesh.primitives.Box;
import com.omnihx3d.mesh.primitives.Cylinder;
import com.omnihx3d.mesh.primitives.Ground;
import com.omnihx3d.mesh.primitives.Sphere;
import com.omnihx3d.mesh.primitives.Torus;
import com.omnihx3d.mesh.primitives.TorusKnot;
...
@:expose('BABYLON.BabylonLiteFileLoader') class BabylonLiteFileLoader {
    ...
    private static function parsePlane(parsedPlane:Dynamic, scene:Scene):Geometry {
        ...
        var plane = new com.omnihx3d.mesh.primitives.Plane(parsedPlane.id, scene, parsedPlane.s, parsedPlane.cBR, null);
