...
import com.omnihx3d.postprocess.renderpipeline.PostProcessRenderPipeline;
import com.omnihx3d.postprocess.renderpipeline.PostProcessRenderEffect;
	...
	*/
	private function _createHDRPostProcess(scene:Scene, ratio:Float) {
		...
		this._hdrPostProcess.onApply = function(effect:Effect) {
			...
			this._hdrOutputLuminance = com.omnihx3d.math.Tools.Clamp(this._hdrOutputLuminance, this.minimumLuminance, this.maximumLuminance);
