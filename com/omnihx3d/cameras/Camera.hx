...
import com.omnihx3d.postprocess.StereoscopicInterlacePostProcess;
import com.omnihx3d.postprocess.VRDistortionCorrectionPostProcess;
...
@:expose('BABYLON.Camera') class Camera extends Node implements IAnimatable {
	...
	public function new(name:String, position:Vector3, scene:Scene) {
		...
		#if purejs
		eventPrefix = com.omnihx3d.tools.Tools.GetPointerPrefix();
		#end
	}
